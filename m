...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1FCDD2458A4
	for <lists+linux-sh@lfdr.de>; Sun, 16 Aug 2020 19:02:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727973AbgHPRCm (ORCPT <rfc822;lists+linux-sh@lfdr.de>);
        Sun, 16 Aug 2020 13:02:42 -0400
Received: from outpost1.zedat.fu-berlin.de ([130.133.4.66]:52707 "EHLO
        outpost1.zedat.fu-berlin.de" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726825AbgHPRCl (ORCPT
        <rfc822;linux-sh@vger.kernel.org>); Sun, 16 Aug 2020 13:02:41 -0400
Received: from inpost2.zedat.fu-berlin.de ([130.133.4.69])
          by outpost.zedat.fu-berlin.de (Exim 4.93)
          with esmtps (TLS1.2)
          tls TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
          (envelope-from <glaubitz@zedat.fu-berlin.de>)
          id 1k7M3K-000LBC-TO; Sun, 16 Aug 2020 19:02:38 +0200
Received: from suse-laptop.physik.fu-berlin.de ([160.45.32.140])
          by inpost2.zedat.fu-berlin.de (Exim 4.93)
          with esmtpsa (TLS1.2)
          tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
          (envelope-from <glaubitz@physik.fu-berlin.de>)
          id 1k7M3K-000LlQ-Nt; Sun, 16 Aug 2020 19:02:38 +0200
...
References: <b9ea23ec-4925-aee6-07a8-571971a42194@physik.fu-berlin.de>
 ...
 <20200816170041.GA3265@brightrain.aerifal.cx>
...
Message-ID: <0f514caa-8203-f767-bde7-9e008468e69b@physik.fu-berlin.de>
Date:   Sun, 16 Aug 2020 19:02:38 +0200
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.11.0
MIME-Version: 1.0
In-Reply-To: <20200816170041.GA3265@brightrain.aerifal.cx>
...
On 8/16/20 7:00 PM, Rich Felker wrote:
...
Geert has got a LANDISK device working now that I sent to him (hence the
bug fixes he sent), so I'm confident we will be able to fix the remaining
issues with combined forces :-).
