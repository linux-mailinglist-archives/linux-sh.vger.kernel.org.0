Return-Path: <linux-sh+bounces-725-lists+linux-sh=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-sh@lfdr.de
Delivered-To: lists+linux-sh@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 63410897EA7
	for <lists+linux-sh@lfdr.de>; Thu,  4 Apr 2024 07:03:29 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 17BCA289B17
	for <lists+linux-sh@lfdr.de>; Thu,  4 Apr 2024 05:03:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9A711405F9;
	Thu,  4 Apr 2024 05:01:05 +0000 (UTC)
X-Original-To: linux-sh@vger.kernel.org
Received: from sakura.ysato.name (ik1-413-38519.vs.sakura.ne.jp [153.127.30.23])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5EE42634E2
	for <linux-sh@vger.kernel.org>; Thu,  4 Apr 2024 05:01:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=153.127.30.23
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712206865; cv=none; b=n2V46F451ADRPNZpagmg0zw67gpaClBbIK8PKU1zaQzLkgz7TXAHx/tOC8lI/8pXz60MoIObUDi3tovtdbLkAv8oEdOJjsCG4KAIoikbpI1+7JxiNG7iS8dLcrpEvI94Eu5D/mFHY3zR6/zRjk47t9gjy3RmKojvKhAfbYDLEd4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712206865; c=relaxed/simple;
	bh=lu04S1z5esVKIKbtLupdeTesyqNKCVwU4W+dAOV5/pg=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=tcfvGqjWzsWXjbemdzK+6du74xlywjkjxPtvanqwGzE5yzqtiVkEkUSXieI8GR4FV31UX8vhOIUQpze5boQq4lpIvfeomX+dVRoChL7Ek1OIPhKX2QgMlGTQIQsjjod8ZR/+7X6ibNQQERaI1XzqM2E+cuP9uYFgt8RitM9IKQo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=users.sourceforge.jp; spf=fail smtp.mailfrom=users.sourceforge.jp; arc=none smtp.client-ip=153.127.30.23
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=users.sourceforge.jp
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=users.sourceforge.jp
Received: from SIOS1075.ysato.name (al128006.dynamic.ppp.asahi-net.or.jp [111.234.128.6])
	by sakura.ysato.name (Postfix) with ESMTPSA id 011B31C089C;
	Thu,  4 Apr 2024 14:01:02 +0900 (JST)
From: Yoshinori Sato <ysato@users.sourceforge.jp>
To: linux-sh@vger.kernel.org
Cc: Yoshinori Sato <ysato@users.sourceforge.jp>
Subject: [DO NOT MERGE v7 14/36] clk: renesas: Add SH7750/7751 CPG Driver
Date: Thu,  4 Apr 2024 13:59:45 +0900
Message-Id: <59459fd47e77a6978dc83804eba7cd5998016e75.1712041249.git.ysato@users.sourceforge.jp>
