...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1971C7D5877
	for <lists+linux-sh@lfdr.de>; Tue, 24 Oct 2023 18:34:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1343881AbjJXQeC convert rfc822-to-8bit (ORCPT
        <rfc822;lists+linux-sh@lfdr.de>); Tue, 24 Oct 2023 12:34:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55514 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1343914AbjJXQeB (ORCPT
        <rfc822;linux-sh@vger.kernel.org>); Tue, 24 Oct 2023 12:34:01 -0400
Received: from outpost1.zedat.fu-berlin.de (outpost1.zedat.fu-berlin.de [130.133.4.66])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 68A2CAF;
        Tue, 24 Oct 2023 09:33:59 -0700 (PDT)
Received: from inpost2.zedat.fu-berlin.de ([130.133.4.69])
          by outpost.zedat.fu-berlin.de (Exim 4.95)
          with esmtps (TLS1.3)
          tls TLS_AES_256_GCM_SHA384
          (envelope-from <glaubitz@zedat.fu-berlin.de>)
          id 1qvKLp-0042PD-CU; Tue, 24 Oct 2023 18:33:53 +0200
Received: from p57bd9695.dip0.t-ipconnect.de ([87.189.150.149] helo=[192.168.178.81])
          by inpost2.zedat.fu-berlin.de (Exim 4.95)
          with esmtpsa (TLS1.3)
          tls TLS_AES_256_GCM_SHA384
          (envelope-from <glaubitz@physik.fu-berlin.de>)
          id 1qvKLp-0004qw-4m; Tue, 24 Oct 2023 18:33:53 +0200
Message-ID: <40a430b427d217bb070c562c7c676937ef965efe.camel@physik.fu-berlin.de>
Subject: Re: [PATCH 4/4] [v2] sh: machvec: remove custom ioport_{un,}map()
...
Date:   Tue, 24 Oct 2023 18:33:52 +0200
In-Reply-To: <20230914155523.3839811-4-arnd@kernel.org>
References: <20230914155523.3839811-1-arnd@kernel.org>
         <20230914155523.3839811-4-arnd@kernel.org>
