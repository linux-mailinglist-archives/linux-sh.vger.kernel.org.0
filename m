Return-Path: <linux-sh+bounces-3518-lists+linux-sh=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-sh@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id UM8bECBgsGloigIAu9opvQ
	(envelope-from <linux-sh+bounces-3518-lists+linux-sh=lfdr.de@vger.kernel.org>)
	for <lists+linux-sh@lfdr.de>; Tue, 10 Mar 2026 19:17:04 +0100
X-Original-To: lists+linux-sh@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id D2FC62564CA
	for <lists+linux-sh@lfdr.de>; Tue, 10 Mar 2026 19:17:03 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 6B0F731B646E
	for <lists+linux-sh@lfdr.de>; Tue, 10 Mar 2026 18:13:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 151173D9DDB;
...
X-Spamd-Result: default: False [0.94 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TO_DN_SOME(0.00)[];
	TAGGED_FROM(0.00)[bounces-3518-lists,linux-sh=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	RCVD_TLS_LAST(0.00)[];
	...
	FROM_NEQ_ENVFROM(0.00)[Slava.Dubeyko@ibm.com,linux-sh@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
