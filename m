Return-Path: <linux-sh+bounces-3548-lists+linux-sh=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-sh@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SJNwHfr0sWl7HQAAu9opvQ
	(envelope-from <linux-sh+bounces-3548-lists+linux-sh=lfdr.de@vger.kernel.org>)
	for <lists+linux-sh@lfdr.de>; Thu, 12 Mar 2026 00:04:26 +0100
X-Original-To: lists+linux-sh@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 2278926B184
	for <lists+linux-sh@lfdr.de>; Thu, 12 Mar 2026 00:04:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 3DE2A304F5E7
	for <lists+linux-sh@lfdr.de>; Wed, 11 Mar 2026 23:03:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 01DAC3A16A2;
...
X-Spamd-Result: default: False [3.14 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-3548-lists,linux-sh=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[kieran.bingham@ideasonboard.com,linux-sh@vger.kernel.org];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,avm.de:email,linuxfoundation.org:email,ideasonboard.com:email,ping.linuxembedded.co.uk:mid]
X-Rspamd-Queue-Id: 2278926B184
