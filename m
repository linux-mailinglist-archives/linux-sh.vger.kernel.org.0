Return-Path: <linux-sh+bounces-3666-lists+linux-sh=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-sh@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 8LBYFSmX32nXWQAAu9opvQ
	(envelope-from <linux-sh+bounces-3666-lists+linux-sh=lfdr.de@vger.kernel.org>)
	for <lists+linux-sh@lfdr.de>; Wed, 15 Apr 2026 15:48:25 +0200
X-Original-To: lists+linux-sh@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 86351404FC8
	for <lists+linux-sh@lfdr.de>; Wed, 15 Apr 2026 15:48:24 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 5B744300DA42
	for <lists+linux-sh@lfdr.de>; Wed, 15 Apr 2026 13:44:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 086873AEF5F;
	Wed, 15 Apr 2026 13:44:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="O14Y6OiI"
X-Original-To: linux-sh@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D6EB35CDF1;
	Wed, 15 Apr 2026 13:44:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1776260661; cv=none; b=k2VOU+DjpZVluc17qgxYsZt/EZZpdWVw4yIJiU7L+q3nYNE7VX6IVzQYKTqqJ8auB50wOtnuFvKDU6Tr0WzVKyi50XfEtu5wHtOz1F6VlPd1ZzuK60Y5Rz7lOrRospK1mAIRHBPwGSgSynZkcuUhYgYrmN/iOQ5GTTw9lj8dMiM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1776260661; c=relaxed/simple;
	bh=cvffzfRce8gu2XSdRh+/ukuCm0L1lipxNYSi9OVpUvA=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=thxmUhAwT5BkmfAdb9SRxWP1v72Ji3uNDp477UETnFOwHQqs9yv68d0IEQ8+mg2az6xWJhxLkTuf0Y6JQutSNKlMgjI3PYqqmpT1tko9iMo061VBqsWOnYCooZd388Y99kun2+ZHQAQKu6MJkmqLjHiaKqBtUVWrt6NOgocd/cQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=O14Y6OiI; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 6615EC19424;
	Wed, 15 Apr 2026 13:44:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1776260661;
	bh=cvffzfRce8gu2XSdRh+/ukuCm0L1lipxNYSi9OVpUvA=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <9d8eda244e79b3b1c43c45277f225b130e88fa70.camel@kernel.org>
...
Date: Wed, 15 Apr 2026 06:44:20 -0700
...
X-Spamd-Result: default: False [-1.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-3666-lists,linux-sh=lfdr.de];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[phoronix.com:url,tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns]
X-Rspamd-Queue-Id: 86351404FC8
...
> in 32-bit architectures, I'm only notified about the performance impact o=
n
> these systems now as the pull request has already been sent to Linus.
>=20
> I'm frustrated by this poor communication style. If your change affects c=
ertain
> users negatively, it should be openly communicated to them on the appropr=
iate
> mailing lists so that they at least get to raise concerns. Disclosing the=
se
